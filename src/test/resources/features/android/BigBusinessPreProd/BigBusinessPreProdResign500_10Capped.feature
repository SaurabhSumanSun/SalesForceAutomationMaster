Feature: feature001
  ...
  Scenario Outline: To verify Sales rep is able to do Resign journey with 500 connections of Big Business product with data allowance capped at 10GB and validate the basket in Pre Prod
