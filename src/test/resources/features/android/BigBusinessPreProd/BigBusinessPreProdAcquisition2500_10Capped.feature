Feature: feature001
  ...
  Scenario Outline: To verify Sales rep is able to do acquisition with 2500 connections of Big Business product with data allowance capped at 10GB and validate the basket in Pre Prod
