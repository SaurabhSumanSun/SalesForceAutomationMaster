Feature: feature001
  ...
  Scenario Outline: To verify Sales rep is able to do Resign journey with 2500 connections of Big Business product with PAYU voice only plan and validate the basket in Pre Prod
