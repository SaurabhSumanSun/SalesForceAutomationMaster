Feature: feature001
  ...
  Scenario Outline: To verify Sales rep is able to do acquisition with 2500 connections of Big Business product with (10 GB) data only plan and validate the basket in Pre Prod
