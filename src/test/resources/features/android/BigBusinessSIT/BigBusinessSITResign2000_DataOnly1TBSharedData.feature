Feature: feature001
  ...
  Scenario Outline: To verify Sales rep is able to do Resign journey with 2000 connections of Big Business product with (1 TB Shared Data) data only plan and validate the basket in SIT
