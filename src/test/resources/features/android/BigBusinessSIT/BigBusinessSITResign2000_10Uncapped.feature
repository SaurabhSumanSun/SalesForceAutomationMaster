Feature: feature001
  ...
  Scenario Outline: To verify Sales rep is able to do Resign journey with 2000 connections of Big Business product with 10GB uncapped data allowance and validate the basket in SIT
