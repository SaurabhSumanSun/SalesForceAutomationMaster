Feature: feature001
  ...
  Scenario Outline: To verify Sales rep is able to do Resign Journey with 1000 connections of Big Business product with Unlimited voice only plan and validate the basket in SIT
