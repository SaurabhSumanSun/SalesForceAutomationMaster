Feature: feature001
  ...
  Scenario Outline: To verify Sales rep is able to do acquisition with 2000 connections of Big Business product with unlimited voice and data capped at 10GB and validate the basket in Pre Prod
    ...
    Examples:
      ...
      |ID_414 ID_415 ID_416|Test Private  | Acquisition| Self-serve pricing tools| 2000              | No                 | No           |No        |No           |            |Voice & Data |Unlimited|24  |Individual|10GB           |Uncapped        |              |                  |              |100|
