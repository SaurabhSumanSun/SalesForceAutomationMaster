Feature: feature001
  ...
  Scenario Outline: To verify Sales rep is able to do Resign journey with 500 connections of Big Business product with Unlimited voice only plan and validate the basket in SIT
