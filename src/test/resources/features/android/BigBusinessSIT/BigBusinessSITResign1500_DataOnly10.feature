Feature: feature001
  ...
  Scenario Outline: To verify Sales rep is able to do Resign Journey with 1500 connections of Big Business product with (10 GB) data only plan and validate the basket in SIT
