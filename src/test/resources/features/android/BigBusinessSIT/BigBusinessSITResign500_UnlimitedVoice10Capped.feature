Feature: feature001
  ...
  Scenario Outline: To verify Sales rep is able to do Resign Journey with 500 connections of Big Business product with unlimited voice and data capped at 10GB and validate the basket in SIT
