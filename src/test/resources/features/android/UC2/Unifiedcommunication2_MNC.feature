Feature: Enterprise industrialisation Unified communication 2
  ...
  @Test
  Scenario Outline: To verify that salesRep is able to complete an E2E order successfully with the PBX, SIP, Fixed Lines, Inbound number in the same basket for MNC account
