Feature: Enterprise industrialisation Unified communication 2
  ...
  Scenario Outline: To verify that salesRep is able to complete an E2E order successfully with the PBX, SIP, Fixed Lines, Inbound number in the same basket
    ...
    Examples:
      ...
      |ID_179 ID_191 ID_192 ID_193 ID_219 ID_230 ID_231 ID_232 ID_244 ID_245 ID_246 ID_263 ID_270 ID_271 ID_272 ID_282 ID_283 ID_284 ID_306 ID_313 ID_314 ID_315 ID_030 ID_48|TestSGAccount| Acquisition| Self-serve pricing tools |
