Feature: Flex Plan End to End Journey
  ...
  Scenario Outline: To verify Sales rep is able to perform an E2E with Standard FlexPlan product having term of 24 months, 20 'aggregated data only SIMs' and 'Flex Plan Two 5GB' tariff
