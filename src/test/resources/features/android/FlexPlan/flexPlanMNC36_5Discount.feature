Feature: Flex Plan End to End Journey with discount
  ...
  Scenario Outline: To verify Sales rep is able to perform an E2E with Standard FlexPlan product having term of 36 months, 'Flex Plan 2GB' tariff and provide 5 discount for MNC account
