Feature: Flex Plan End to End Journey with discount
  ...
  Scenario Outline: To verify Sales rep is able to perform an E2E with Standard FlexPlan product having term of 24 months, 'Flex Plan Two Unlimited' tariff and provide 3 discount for MNC account
