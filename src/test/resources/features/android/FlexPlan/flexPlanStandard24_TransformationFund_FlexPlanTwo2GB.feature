Feature: Flex Plan End to End Journey
  ...
  Scenario Outline: To verify Sales rep is able to perform an E2E with Standard FlexPlan product having term of 24 months, transformation fund and 'Flex Plan Two 2GB' tariff
