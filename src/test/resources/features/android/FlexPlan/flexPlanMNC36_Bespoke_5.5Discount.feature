Feature: Flex Plan End to End Journey with discount
  ...
  Scenario Outline: To verify Sales rep is able to perform an E2E with Bespoke FlexPlan product having term of 36 months, 'Flex Plan Two 5GB' tariff and provide 5 discount for a MNC account
