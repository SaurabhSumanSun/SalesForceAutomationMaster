Feature: Flex Plan End to End Journey with discount
  ...
  Scenario Outline: To verify Sales rep is able to perform an E2E with Standard FlexPlan product having term of 24 months, 'Flex Plan 1GB' tariff and provide 4 discount
