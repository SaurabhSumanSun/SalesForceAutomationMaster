Feature: Flex Plan End to End Journey for MNC account
  ...
  Scenario Outline: To verify Sales rep is able to perform an E2E with FlexPlan product having term of 24 months, 20 'aggregated data only SIMs' and 'Flex Plan Two 5GB' tariff for a MNC account
    ...
    Examples:
      ...
      |140                    |1000+ Sites   | Acquisition| Self-serve pricing tools   |Standard (Fast-Track)|Bespoke (Approval Required)|0|24  |100                           |20                       |No                 |Flex Plan Two 5GB       |0       |No         |
