Feature: Flex Plan End to End Journey for MNC account
  ...
  Scenario Outline: To verify Sales rep is able to perform an E2E Bespoke journey with FlexPlan product having term of 24 months and 'Flex Plan 20GB' tariff for a MNC account
    ...
    Examples:
      ...
      |                       |1000+ Sites   | Acquisition| Self-serve pricing tools   |Standard (Fast-Track)|Bespoke (Approval Required)|1|24  |100                           |0                        |No                 |Flex Plan 20GB          |0       |No         |
