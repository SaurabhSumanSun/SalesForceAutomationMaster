Feature: Flex Plan Bespoke End to End Journey
  ...
  Scenario Outline: To verify Sales rep is able to perform an E2E with Bespoke FlexPlan product having term of 24 months, 100 'Voice and Aggregated Data SIMs' and 'Flex Plan 10GB' tariff
    ...
    Examples:
      ...
      |070 076 078 079 106    |Test Private  | Acquisition| Self-serve pricing tools   |Standard (Fast-Track)|Bespoke (Approval Required)|1|24  |100                           |0                        |No                 |Flex Plan 10GB          |        |No         |
