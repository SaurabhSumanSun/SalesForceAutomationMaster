Feature: Flex Plan End to End Journey for MNC account
  ...
  Scenario Outline: To verify Sales rep is able to perform an E2E Bespoke journey with FlexPlan product having term of 40 months and 'Flex Plan 5GB' tariff for a MNC account
    ...
    Examples:
      ...
      |183                    |1000+ Sites   | Acquisition| Self-serve pricing tools   |Standard (Fast-Track)|Bespoke (Approval Required)|1|40  |100                           |0                        |No                 |Flex Plan 5GB           |0       |No         |
