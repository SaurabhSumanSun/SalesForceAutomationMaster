Feature: Flex Plan Bespoke End to End Journey
  ...
  Scenario Outline: To verify Sales rep is able to perform an E2E with Bespoke FlexPlan product having term of 24 months, 45 'Voice and Aggregated Data SIMs' and 'Flex Plan 10GB' tariff
