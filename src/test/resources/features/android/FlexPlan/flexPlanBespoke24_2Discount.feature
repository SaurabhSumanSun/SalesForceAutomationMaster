Feature: Flex Plan End to End Journey with discount
  ...
  Scenario Outline: To verify Sales rep is able to perform an E2E with Bespoke FlexPlan product having term of 24 months, 'Flex Plan Two 10GB' tariff and provide 2 discount
